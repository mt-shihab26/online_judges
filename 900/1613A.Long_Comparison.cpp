...
char test_case() {
    ...
    string xs1 = to_string(x1);
    string xs2 = to_string(x2);

    int len1 = xs1.length() + n1;
    int len2 = xs2.length() + n2;
...
// Friday, December 03, 2021 | 10:17:28 AM (+06)
// Accepted: 11:00:19 AM (+06)
