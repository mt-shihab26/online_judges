...
void test_case()
{
    ...
    sort(po_a.begin(), po_a.end(), greater<>());
    sort(ne_a.begin(), ne_a.end(), greater<>());

    int po_n = po_a.size(), ne_n = ne_a.size();
...
// Monday, December 13, 2021 | 02:50:39 PM (+06)
